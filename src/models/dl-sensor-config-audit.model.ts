...
const dataLoggerSensorConfigAuditSchema = new Schema<IDLSensorConfigAudit>(
  {
    dataLoggerId: {
...
const DLSensorConfigAuditModel = mongoose.model<IDLSensorConfigAudit>(
  "dataLoggerSensorConfigAudit",
  dataLoggerSensorConfigAuditSchema,
  "dataLoggerSensorConfigAudit"
);
