...
exports.EventLogsModel = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const events_constants_1 = require("../constants/events.constants");
const eventLogsSchema = new mongoose_1.Schema({
    eventComponentId: {
    ...
    eventStatus: {
        type: String,
        enum: Object.values(events_constants_1.EVENT_STATUS_ENUM),
        default: events_constants_1.EVENT_STATUS_ENUM.INACTIVE,
    },
    workspaceId: {
        type: mongoose_1.Schema.Types.ObjectId,
        ref: "NewWorkspace",
