...
const dataLoggerSensorConfigAuditSchema = new mongoose_1.Schema({
    dataLoggerId: {
...
const DLSensorConfigAuditModel = mongoose_1.default.model("dataLoggerSensorConfigAudit", dataLoggerSensorConfigAuditSchema, "dataLoggerSensorConfigAudit");
