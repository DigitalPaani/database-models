...
const newUserSubSchema = new mongoose_1.Schema({
    _id: { type: mongoose_1.default.Schema.Types.ObjectId },
    ...newUserModel_1.NewUserModel.schema.obj,
}, { _id: false });
const userGroupUserRoleSubSchema = new mongoose_1.Schema({
    _id: { type: mongoose_1.default.Schema.Types.ObjectId },
    ...userGroupUserRole_model_1.UserGroupUserRoleModel.schema.obj,
}, { _id: false });
const userGroupWorkspaceAssetUserRoleSubSchema = new mongoose_1.Schema({
    _id: { type: mongoose_1.default.Schema.Types.ObjectId },
    ...userGroupWorkspaceAssetUserRole_model_1.UserGroupWorkspaceAssetUserRoleModel.schema.obj,
}, { _id: false });
