...
exports.SensorSettingsModel = void 0;
...
const sensorSettingsSchema = new mongoose_1.Schema({
    ...
    aggregation: {
        type: String,
        enum: formulaConst_1.SENSOR_SETTING_AGGREGATION,
        required: true,
        default: "Current",
    },
...
const SensorSettingsModel = mongoose_1.default.model("SensorSettings", sensorSettingsSchema, "sensorSettings");
exports.SensorSettingsModel = SensorSettingsModel;
